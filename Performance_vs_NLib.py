...
run_label = "performance_vs_lib_size"
...
grid_lib = False 
grid_val = True
lib_sizes = list(np.square(np.arange(2, 10 + 1, 1)))
val_size = 25**2
lib_seed = 1001
val_seed = lib_seed + max(lib_sizes)
